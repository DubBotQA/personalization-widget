...
```html
<script src="https://cdn.jsdelivr.net/gh/DubBotQA/personalization-widget@v0.0.7/dist/db-personalization-widget.bundle.js"></script>
```
...
```html
<script
  src="https://cdn.jsdelivr.net/gh/DubBotQA/personalization-widget@v0.0.7/dist/db-personalization-widget.bundle.js"
